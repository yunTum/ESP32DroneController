...
float Kp_rate = 0.60                                                  ;    //P-gain - rate mode
float Ki_rate = 0.01;    //I-gain - rate mode
float Kd_rate = 0.012;   //D-gain - rate mode 
float Kp_yaw  = 0.30;    //Yaw P-gain
float Ki_yaw  = 0.01;    //Yaw I-gain
float Kd_yaw  = 0.05;    //Yaw D-gain 
...
void controlANG() 
{
  ...
  roll_des = Kp_ang * error_roll + Ki_ang * integral_ang_roll - Kd_ang * GyroX;
  ...
  pitch_des = Kp_ang * error_pitch + Ki_ang * integral_ang_pitch - Kd_ang * GyroY;
  ...
  yaw_des = Kp_ayw * error_yaw + Ki_ayw * integral_ang_yaw - Kd_ayw * GyroZ;
